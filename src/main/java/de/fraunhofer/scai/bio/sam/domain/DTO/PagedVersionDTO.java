...
public class PagedVersionDTO  implements Serializable {
  ...
  @Valid
  private List<VersionTagDTO> content = new ArrayList<>();

  public PagedVersionDTO number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public PagedVersionDTO numberOfElements(Integer numberOfElements) {
  ...
  **/
  ...
  public PagedVersionDTO totalElements(Integer totalElements) {
  ...
  **/
  ...
  public PagedVersionDTO totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedVersionDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedVersionDTO content(List<VersionTagDTO> content) {
    this.content = content;
    return this;
  }

  public PagedVersionDTO addContentItem(VersionTagDTO contentItem) {
  ...
  **/
  ...
  public List<VersionTagDTO> getContent() {
    return content;
  }

  public void setContent(List<VersionTagDTO> content) {
    this.content = content;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedVersionDTO pagedVersion = (PagedVersionDTO) o;
