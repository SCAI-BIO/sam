...
public class PagedOntologyDTO  implements Serializable {
  ...
  @Valid
  private List<OntologyDTO> content = new ArrayList<>();

  public PagedOntologyDTO number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public PagedOntologyDTO numberOfElements(Integer numberOfElements) {
  ...
  **/
  ...
  public PagedOntologyDTO totalElements(Integer totalElements) {
  ...
  **/
  ...
  public PagedOntologyDTO totalPages(Integer totalPages) {
  ...
  **/
  ...
  public PagedOntologyDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PagedOntologyDTO content(List<OntologyDTO> content) {
    this.content = content;
    return this;
  }

  public PagedOntologyDTO addContentItem(OntologyDTO contentItem) {
  ...
  **/
  ...
  public List<OntologyDTO> getContent() {
    return content;
  }

  public void setContent(List<OntologyDTO> content) {
    this.content = content;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PagedOntologyDTO pagedTerminology = (PagedOntologyDTO) o;
